...
class _$ShiftModelImpl implements _ShiftModel {
  ...
  @override
  String toString() {
    return 'ShiftModel(id: $id, tenantId: $tenantId, name: $name, description: $description, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, tenantId, name, description, createdAt, updatedAt);
...
abstract class _ShiftModel implements ShiftModel {
  const factory _ShiftModel(
      ...
      @JsonKey(name: 'updated_at') final String? updatedAt}) = _$ShiftModelImpl;
